...
\begin{document}
    ...
    $$
    <\frac{1}{v}>=\int_0^{+\infty}{\frac{1}{v}f_{\mathrm{M}}\left( v \right) \mathrm{d}v=4\pi \left( \frac{m}{2\pi kT} \right) ^{\frac{3}{2}}\int_0^{+\infty}{v}\exp \left( -\frac{mv^2}{2kT} \right) \mathrm{dv}}
    $$
