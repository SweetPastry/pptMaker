...
\begin{document}
	...
	$$
	f_{\mathrm{M}}^{n}\left( v \right) =S_n\left( v \right) \cdot \prod_{i=1}^n{f_M\left( v_i \right)}=\frac{n\pi ^{\tfrac{n}{2}}}{\Gamma \left( \frac{n}{2}+1 \right)}v^{n-1}\left( \frac{m}{2\pi kT} \right) ^{\tfrac{n}{2}}\exp \left( -\frac{mv^2}{2kT} \right) 
	$$
