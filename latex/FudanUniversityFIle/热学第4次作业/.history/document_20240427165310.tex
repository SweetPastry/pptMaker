...
\begin{document}
	...
	$$
	V_n=\frac{\pi ^{\tfrac{n}{2}}}{\Gamma \left( \cfrac{n}{2}-1 \right)}r^n
	$$

	The surface area of the N-dimensional hypersphere can be obtained by taking the derivative of the volume.

	$$
	S_n=\frac{\partial}{\partial r}V_n=\frac{\pi ^{\frac{n}{2}}}{\Gamma \left( \frac{n}{2}-1 \right)}r^n=\frac{n\pi ^{\frac{n}{2}}}{\Gamma \left( \frac{n}{2}-1 \right)}r^{n-1}
	$$
\end{document}
